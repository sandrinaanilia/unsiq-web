          ...
          <div className="bg-white p-6 mt-5 rounded-xl min-h-screen shadow-md">
            <form className="grid gap-4">
              ...
              <div className="col-span-2">
                ...
                <button type="button" className="mt-1 px-4 py-1 bg-red-200 text-red-500 font-bold text-sm rounded-2xl" onClick={handleHapusAkun}>
                  Hapus Akun
                </button>
              </div>
            ...
            {showPopup && (
              <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50">
                <div className="bg-white rounded-3xl shadow-lg p-10 w-96">
                  <h2 className="text-xl text-center font-bold mb-4">Hapus Akun Anda</h2>

                  <div className="flex justify-center">
                    <button className="border border-gray-400 hover:bg-gray-200 text-gray-800 font-bold py-2 px-6 rounded mr-3" onClick={handleCancelHapus}>
                      Tidak
                    </button>
                    <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-6 rounded" onClick={handleConfirmHapus}>
                      Hapus
                    </button>
                  </div>
                </div>
