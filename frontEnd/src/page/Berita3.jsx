        ...
        <div className="container mx-auto px-4">
          <article className="bg-white shadow-md rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <h3 className="text-2xl font-bold mt-2">HALAL BIHALAL & TASYAKURAN</h3>
              <p className="text-gray-600 mt-2">10 Mei 2023 | 2 bulan lalu</p>
            </div>
            <img src={berita3} alt="Berita PPTQ UNSIQ 2" className="w-full h-auto" />
            <div className="p-6">
              <div className="berita text-gray-700">
                ...
                <p className="mt-4">
                  ...
                  yang berprestasi dalam bidang akademik dan non-akademik diberikan penghargaan sebagai bentuk apresiasi dan motivasi untuk terus berprestasi. Acara Halal Bihalal dan Tasyakuran ditutup dengan doa bersama yang dipimpin oleh
                  Ustadz H. Ahmad Fauzi, M.A., memohon keberkahan dan kemudahan dalam menjalani kegiatan di masa mendatang. Seluruh hadirin mengamini doa dengan khusyuk, berharap agar Pondok Pesantren Mahasiswa UNSIQ 2 senantiasa menjadi
                  tempat yang membawa kebaikan dan manfaat bagi semua pihak. Dengan berlangsungnya acara ini, diharapkan semangat kebersamaan dan rasa syukur dapat terus terjaga, serta menjadi awal yang baik untuk menjalani kegiatan
                  akademik dan keagamaan di tahun ajaran baru.
                </p>
              </div>
            </div>
          </article>
