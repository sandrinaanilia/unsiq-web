...
const Galeri = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col w-full">
        ...
        {/* Galeri */}
        <div>
  <h2 className="text-2xl font-bold mb-8 ">Galeri</h2>
  <div className="flex justify-end mb-4">
  <button onClick={() => navigate("/berkasdatasantri")} className="text-teal-600 font-bold px-4 py-2 rounded-md hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500">
            Tambah Foto
          </button>
  ...
  <div className="flex flex-col gap-4">
    <div className="bg-white shadow-lg rounded-lg p-4">
      <img src={Berita1} alt="Image 1" className="w-1/5 rounded-lg" />
      <div className="flex items-center justify-between mt-2">
        <span className="text-center w-full">2 hari lalu</span>
        <div className="flex gap-2">
          <button onClick={() => navigate("/")} className="bg-blue-400 text-white px-2 py-1 rounded">
            view
          </button>
          <button onClick={() => navigate("/")} className="bg-red-400 text-white px-2 py-1 rounded">
            delete
          </button>
        </div>
      </div>
    ...
    <div className="bg-white shadow-lg rounded-lg p-4">
      <img src={Berita2} alt="Image 2" className="w-1/5 rounded-lg" />
      <div className="flex items-center justify-between mt-2">
        <span className="text-center w-full">7 hari lalu</span>
        <div className="flex gap-2">
          <button onClick={() => navigate("/")} className="bg-blue-400 text-white px-2 py-1 rounded">
            view
          </button>
