...
function FormulirPendaftaran() {
  ...
  return (
    <>
      <Navbar />
      <div className="flex justify-center py-10 px-10 min-h-screen bg-gray-100">
        ...
        <div className="flex flex-1 justify-center items-center">
          <div className="flex w-full max-w-4xl bg-white rounded-lg shadow-lg p-8 mt-20">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label htmlFor="tahunMasuk" className="block text-base font-medium text-black">
                        Tahun Mendaftar Pondok
                      </label>
                      <input
                        type="text"
                        id="tahunMasuk"
                        name="tahunMasuk"
                        placeholder="Masukan tahun mendaftar Pondok"
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        id="telpOrtu"
                        name="telpOrtu"
                        placeholder="Masukan nomor telepon orang tua Anda"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="pasFoto"
                        onChange={handleInputChange}
                        className="mt-1 block w-full text-sm text-gray-900 bg-gray-50 border border-gray-300 cursor-pointer focus:outline-none focus:border-teal-500 focus:ring-teal-500"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <select id="kategori" name="kategori" value={formValues.kategori} onChange={handleInputChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 text-sm">
                        <option value="reguler">Reguler</option>
                        <option value="karyawan">Beasiswa 5-10 Juz </option>
                        <option value="karyawan">Beasiswa 11-20 Juz </option>
                        <option value="karyawan">Beasiswa 21-29 Juz </option>
                        <option value="karyawan">Beasiswa 30 Juz </option>
                      </select>
                    </div>
                  </div>
                </div>
                <div className="flex justify-center">
                  <button type="button" onClick={handleSubmit} className="w-1/4 py-2 px-4 bg-teal-600 text-white font-bold rounded-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
                    Kirim
                  </button>
                </div>
              </form>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center  bg-gray-900 bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="mb-4">Untuk informasi pembayaran bisa lihat di Notifikasi "🔔"</p>
              <button className="py-2 px-4 bg-teal-600 text-white font-bold rounded-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500" onClick={() => setIsModalOpen(false)}>
                Tutup
              </button>
            </div>
          </div>
